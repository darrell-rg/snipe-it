...
script.append(('Boot','04'))
script.append(('Get Version','03'))
script.append(('Get Current Temperature','72'))
script.append(('Get Available Regions','71'))
script.append(('Get Available Protocols','70'))
# script.append(('exit','xx'))
script.reverse()
# 04 = Boot 

# for cmd,txt in script:
while (txt != 'xx'):
    if(len(script) > 0):
        cmd, txt = script.pop()
        print()
